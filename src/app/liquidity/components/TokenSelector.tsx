...
export default function TokenSelector({ value, onChange, placeholder, chainId = ChainId.SONIC_BLAZE_TESTNET, excludeToken }: TokenSelectorProps) {
          ...
          <div className="flex items-center space-x-3">
            ...
            <div 
              className={`w-8 h-8 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center text-white font-bold text-sm ${
                selectedToken.logoURI ? 'hidden' : 'flex'
              }`}
            >
