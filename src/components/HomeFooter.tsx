                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pb-8">
                        ...
                        <div className="col-span-1 md:col-span-1">
                            ...
                            <div className="flex space-x-4">
                                ...
                                <a
                                    href="https://pennysia.com"
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors"
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-discord h-5 w-5" viewBox="0 0 16 16">
                                ...
                                <a
                                    ...
                                    className="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors"
                                >
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="bi bi-github h-5 w-5" viewBox="0 0 16 16">
