  ...
  return (
    <div className="max-w-6xl mx-auto mt-64 mb-16 px-4 md:pt-48">
      ...
      <div className="space-y-8 pb-12">
        {/* Trade */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-top bg-gray-200/50 dark:bg-[#555C6F]/10 backdrop-blur-sm rounded-2xl p-6 md:p-8">
          <div className="flex flex-col h-full w-full text-left relative">
            <div className="w-fit flex items-center flex-row bg-gray-200 dark:bg-[#555C6F]/10 rounded-xl py-2 px-2 mb-2">
              <svg
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-top">
          {/* Provide Liquidity */}
          <div className="flex flex-col h-full w-full text-left relative gap-4 items-top bg-gray-200/50 dark:bg-[#555C6F]/10 backdrop-blur-sm rounded-2xl p-6 md:p-8">
            <div className="flex flex-col h-full w-full text-left relative ">
              <div className="w-fit flex items-center flex-row bg-gray-200 dark:bg-[#555C6F]/10 rounded-xl py-2 px-1 mb-2">
                <svg
