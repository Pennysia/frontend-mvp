        ...
        <div className="relative text-center items-center flex flex-col overflow-hidden rounded-3xl">
          ...
          <div className="max-w-7xl grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 px-4 sm:px-0">
            ...
            <div className="p-6 bg-white dark:bg-[var(--background)]/50 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 text-left">
              <div className="w-28 h-28 mx-auto my-22 rounded-full bg-gradient-to-br from-blue-400 to-purple-600 flex items-center justify-center">
            ...
            {/* Card 2 */}
            <div className="p-6 bg-white dark:bg-[var(--background)]/50 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 text-left">
              <div className="w-28 h-28 mx-auto my-22 rounded-full bg-gradient-to-br from-green-400 to-teal-600 flex items-center justify-center">
                <div className="w-22 h-22 rounded-full bg-white/20 backdrop-blur-sm"></div>
              </div>
              <h3 className="pt-6 text-2xl font-semibold text-gray-900 dark:text-white mb-2 transition-colors duration-300">
                Bidirectional <br />
            ...
            {/* Card 3 */}
            <div className="p-6 bg-white dark:bg-[var(--background)]/50 backdrop-blur-sm rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 text-left">
              <div className="w-28 h-28 mx-auto my-22 rounded-full bg-gradient-to-br from-orange-400 to-red-600 flex items-center justify-center">
                <div className="w-22 h-22 rounded-full bg-white/20 backdrop-blur-sm"></div>
              </div>
              <h3 className="pt-6 text-2xl font-semibold text-gray-900 dark:text-white mb-2 transition-colors duration-300">
          ...
          <div className="max-w-7xl mx-auto mt-24 mb-16 px-4 sm:px-0">
            <h2 className="text-3xl md:text-4xl font-semibold text-center text-[#2E2F46] dark:text-white mb-36">
              Leverage your on-chain strategy.
            </h2>
            ...
            <div className="space-y-40">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-top">
                <div className="flex justify-center md:justify-start pointer-events-none">
                  <div className="w-128 h-84 bg-gradient-to-br from-blue-400 to-blue-600 rounded-2xl flex items-center justify-center">
                    <svg
                ...
                <div className="flex flex-col h-full w-full text-left relative">
                  <h3 className="text-3xl md:text-5xl font-normal text-[#2E2F46] dark:text-white mb-3">
                  ...
                  <Link
                    href="/swap"
                    className="text-[#19192A] dark:text-white inline-flex items-center w-fit mt-6 hover:bg-[#EEEEEE] bg-transparent border border-[#555C6F] font-normal py-3 px-6 rounded-lg transition-all duration-200 relative z-10"
                  >
                    Swap now
                  </Link>
                </div>
          ...
          <div className="relative w-full max-w-7xl mx-auto mt-24 mb-8">
            ...
            {/* FAQ Section */}
            <div className="max-w-4xl mx-auto mt-48 mb-16 px-4 sm:px-0">
              ...
              <div className="max-w-6xl mx-auto mt-24 mt-36 mb-8 px-4 sm:px-0">
