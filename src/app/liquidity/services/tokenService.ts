...
class TokenService {
  ...
  private readonly RPC_URLS: Record<number, string> = {
    ...
    57054: 'https://rpc.blaze.soniclabs.com' // Sonic Blaze testnet
  }
  ...
  private getFallbackTokenList(): TokenList {
    // Fallback tokens for common chains (Ethereum mainnet, Sonic Blaze testnet)
    return {
      ...
      tokens: [
        ...
        // Sonic Blaze Testnet (chainId: 57054) - Testnet tokens
        {
          chainId: 57054,
