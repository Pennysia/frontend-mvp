...
export default function SwapPage() {
  return (
    <div className="pt-20 md:pt-24 min-h-screen bg-gray-50 dark:bg-[var(--background)]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-3">
            <div className="dark:bg-[var(--background)]/50">
              <h1 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4 transition-colors duration-300">Swap Tokens</h1>
